...
[OLS regression](/OLSRegression.html) fits a linear model with coefficients $w = (w_1, ..., w_p)$ to minimize the RSS between the observed and the predicted responses.  
